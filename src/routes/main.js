...
router.put(
  "/person/status",
  authMiddleware,
  pessoasController.setStatusPessoaCanal
);
router.get("/person/points/zerar", pessoasController.zerarPontosPessoas);
router.put(
  "/person/acconutLink",
  authMiddleware,
  pessoasController.setAccountLink
);
...
router.get("/channel/:name_channel", canalController.findCanaisByName);
...
//products
router.get(
  "/products/reload_products_cs",
  authMiddleware,
  productsController.registerProductsCs
);
router.post(
  "/products",
  authMiddleware,
...
router.put(
  "/products/:id/status",
  authMiddleware,
  productsController.changeStatusProduct
);
router.get("/products", productsController.listProducts);
router.get("/products/:id", authMiddleware, productsController.findProductById);
...
router.delete(
  "/products/sticker",
  authMiddleware,
  productsController.deleteStickerProduct
);
router.delete(
  "/products/:id",
  authMiddleware,
...
router.post(
  "/products/redeeem",
  authMiddleware,
  productsController.redeemProduct
);
...
router.get(
  "/auth/url-twitch-linkedAccount",
  authController.getUrlTwitchLinkedAccount
);
...
router.post(
  "/auth/cadastro_streamer",
  authMiddleware,
  upload.any(),
  authController.registerAuthStreamer
);
...
router.post(
  "/adm/permissions",
  authMiddleware,
  permissionControler.registerPermission
);
...
router.post(
  "/adm/perguntas",
  authMiddleware,
  perguntaController.registerPergunta
);
router.get("/adm/perguntas", authMiddleware, perguntaController.listPerguntas);
router.get(
  "/adm/perguntas/status",
  authMiddleware,
  perguntaController.statusPerguntas
);
router.get(
  "/adm/perguntas/:id",
  authMiddleware,
  perguntaController.findPergunta
);
router.delete(
  "/adm/perguntas/:id",
  authMiddleware,
  perguntaController.deletePergunta
);
router.put(
  "/adm/perguntas/:id",
  authMiddleware,
  perguntaController.atualizarPergunta
);
...
router.post(
  "/adm/premiacoes",
  authMiddleware,
  upload.single("image_premio"),
  premiacaoController.registerPremiacao
);
router.get(
  "/adm/premiacoes",
  authMiddleware,
  premiacaoController.listPremiacoes
);
router.get(
  "/adm/premiacoes/:id",
  authMiddleware,
  premiacaoController.findPremiacao
);
router.delete(
  "/adm/premiacoes/:id",
  authMiddleware,
  premiacaoController.deletePremiacao
);
...
router.get(
  "/adm/partidas/atual",
  authMiddleware,
  partidaController.findPartidaAtual
);
router.get("/adm/partidas/:id", authMiddleware, partidaController.findPartida);
router.delete(
  "/adm/partidas/:id",
  authMiddleware,
  partidaController.deletePartida
);
router.put(
  "/adm/partidas/:id",
  authMiddleware,
  partidaController.atualizarPartida
);
...
router.post(
  "/adm/categorias",
  authMiddleware,
  categoriasController.registerCategoria
);
router.get(
  "/adm/categorias",
  authMiddleware,
  categoriasController.listCategorias
);
router.get(
  "/adm/categorias/:id",
  authMiddleware,
  categoriasController.findCategoria
);
router.delete(
  "/adm/categorias/:id",
  authMiddleware,
...
router.get(
  "/twitch/SyncPoints",
  authMiddleware,
  pointsController.activeSyncPointsTwitch
);
router.get(
  "/twitch/SyncPubsub",
  authMiddleware,
  pointsController.changeSyncPubsub
);
...
router.get(
  ...
  authMiddleware,
  pointsController.restorePointsStreamElements
);
//RedeemPoints
router.get(
  "/redeemPoints",
  authMiddleware,
  redeeemPointsController.listRedeemPoints
);
router.get(
  "/redeemPoints/register/pendentes",
  authMiddleware,
  redeeemPointsController.registerRedeemPotionsPendentes
);
router.put(
  "/points/:id_channel/:points/roleta",
  authMiddleware,
  pointsController.roletaPoints
);
router.put(
  "/points/:nickname/:points/add",
  authMiddleware,
  pointsController.addpointsManual
);
...
router.get(
  "/redeemProducts",
  authMiddleware,
  redeemProductsController.listRedeemProducts
);
router.put(
  "/redeemProducts",
  authMiddleware,
  redeemProductsController.changeStatusRedeemProducts
);
